...
model = YOLO("best27.pt")  # load a pretrained model (recommended for training)
...
# print(results)
# #
img_path = "C:/Users/15695/Desktop/testImage"
...
results = model.predict(img_path,save=True,save_txt=True,conf=0.5)
